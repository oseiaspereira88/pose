...
**Outcome:** prove delivery value across repositories and compose the open core with Crisol for durable, policy-governed operation.
...
- specs: pose-crisol-control-plane-integration
...
- Keep POSE usable offline when Crisol or an observability backend is absent.
