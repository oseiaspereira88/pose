...
### Implementation
- [ ] Increment 1: Fixture repositories per source framework (R4)
- [ ] Increment 2: Spec Kit guide, including what does not transfer (R1, R2, R3)
- [ ] Increment 3: OpenSpec guide (R1, R2, R3)
- [ ] Increment 4: Executable migration tests (R4)
