...
- [open] Assert in the workflow contract that this repository's CI sets the environment the guard keys on, so a provider or workflow change cannot turn the failure back into a silent skip — owner:unowned crit:medium review:2026-12-10
