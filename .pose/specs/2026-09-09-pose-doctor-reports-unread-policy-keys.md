...
- [open] Extend the unread-key finding to the delivery, artifact and capability policies, which have the same silent-default exposure — owner:unowned crit:medium review:2026-12-09
