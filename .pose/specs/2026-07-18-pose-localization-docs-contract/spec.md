...
- [done] Confirm the first `mkdocs build --strict` CI run (`docs.yml`) against this spec's page edits — not executable in this sandbox (no `pip`/`mkdocs`). Confirmed on run 31148183904: strict build clean, no warnings. (owner:@pose-maintainers crit:medium review:2026-08-19)
