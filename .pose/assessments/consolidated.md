...
> **Data de Avaliação**: 2026-09-24T22:46:40Z
...
- **Linhas de Código de Produção**: 50684
- **Linhas de Código de Testes**: 38685
- **Total Geral de Linhas de Código**: 89369
...
- **Gaps de Integração Identificados**: 56
...
| 03 | `pose-mcp` | `pose-mcp` | `go` | 49814 | 37656 | 340 | 0 | 100% | `verified` |
