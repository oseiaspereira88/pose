...
> **Data de Avaliação**: 2026-08-03T06:34:47Z
> **Baseline Commit**: 369130a1d236
...
| DEBT-015 | `TODO` | `pose-mcp-internal-cli` | [cli.go:422](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/cli/cli.go#L422) | `Todos os comandos executam no binário Go, sem fallbacks Bash ou Py...` | 📌 Sugere Follow-up |
...
| DEBT-022 | `TODO` | `pose-mcp-internal-mcpserver` | [server.go:2035](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/mcpserver/server.go#L2035) | `"technical debt markers (TODO, FIXME, stub, panic), detected langua...` | 📌 Sugere Follow-up |
| DEBT-023 | `TODO` | `pose-mcp-internal-mcpserver` | [server.go:2112](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/mcpserver/server.go#L2112) | `"description": "Audit technical debt markers (TODO, FIXME, stub, pa...` | 📌 Sugere Follow-up |
| DEBT-024 | `TODO` | `pose-mcp-internal-mcpserver-testdata` | [tool-catalog.golden.json:939](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/mcpserver/testdata/tool-catalog.golden.json#L939) | `"description": "Perform a deep discovery audit of a repository comp...` | 📌 Sugere Follow-up |
| DEBT-025 | `TODO` | `pose-mcp-internal-mcpserver-testdata` | [tool-catalog.golden.json:1018](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/mcpserver/testdata/tool-catalog.golden.json#L1018) | `"description": "Audit technical debt markers (TODO, FIXME, stub, pa...` | 📌 Sugere Follow-up |
