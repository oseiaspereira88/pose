...
> **Data de Avaliação**: 2026-08-03T05:16:39Z
> **Baseline Commit**: b6b0c10afdfc
...
| DEBT-015 | `TODO` | `pose-mcp-internal-cli` | [cli.go:407](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/cli/cli.go#L407) | `Todos os comandos executam no binário Go, sem fallbacks Bash ou Py...` | 📌 Sugere Follow-up |
...
| DEBT-022 | `TODO` | `pose-mcp-internal-mcpserver` | [server.go:2016](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/mcpserver/server.go#L2016) | `"technical debt markers (TODO, FIXME, stub, panic), detected langua...` | 📌 Sugere Follow-up |
| DEBT-023 | `TODO` | `pose-mcp-internal-mcpserver` | [server.go:2093](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/mcpserver/server.go#L2093) | `"description": "Audit technical debt markers (TODO, FIXME, stub, pa...` | 📌 Sugere Follow-up |
| DEBT-024 | `TODO` | `pose-mcp-internal-mcpserver-testdata` | [tool-catalog.golden.json:919](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/mcpserver/testdata/tool-catalog.golden.json#L919) | `"description": "Perform a deep discovery audit of a repository comp...` | 📌 Sugere Follow-up |
| DEBT-025 | `TODO` | `pose-mcp-internal-mcpserver-testdata` | [tool-catalog.golden.json:998](file:///home/go/IdeaProjects/harne8/pose-dist/pose-mcp/internal/mcpserver/testdata/tool-catalog.golden.json#L998) | `"description": "Audit technical debt markers (TODO, FIXME, stub, pa...` | 📌 Sugere Follow-up |
