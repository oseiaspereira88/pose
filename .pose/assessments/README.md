# Component Assessments: pose-dist
...
|----|------------|---------------|-----------|--------------|------------|----------|--------|--------------------|
| 01 | `mcp-enforce` | `mcp-enforce` | `go` | 870 | 1029 | 17 | `verified` | [mcp-enforce.md](./mcp-enforce.md) |
| 02 | `pose-mcp` | `pose-mcp` | `go` | 26477 | 16766 | 193 | `verified` | [pose-mcp.md](./pose-mcp.md) |
