...
var catalogGovernance = map[string]toolGovernance{
	...
	"pose_capability_stale":             {Risk: RiskRead},
	"pose_docs_state":                   {Risk: RiskRead},
	...
	"pose_spec_transfer_status":         {Risk: RiskRead},
	"pose_delivery_integrity":           {Risk: RiskRead},
	"pose_surface_assurance":            {Risk: RiskRead},
	"pose_get_changelog":                {Risk: RiskRead},
	"pose_release_status":               {Risk: RiskRead},
	...
	"pose_design_delta":                 {Risk: RiskRead},
