...
sections `Required reading`, `Steps`, `Output requirements`.

## Catálogo (9 skills)

| Skill | Tipo de tarefa | Workflow primário | Rules base |
|---|---|---|---|
| [pose-feature](pose-feature/SKILL.md) | Feature / refactor not-trivial | [feature.md](../../.pose/workflows/feature.md) | security, documentation-style + domínio |
...
| [pose-test-plan](pose-test-plan/SKILL.md) | Plano de teste antes de codar (risk médio/alto) | [feature.md](../../.pose/workflows/feature.md) ou [bugfix.md](../../.pose/workflows/bugfix.md) | security, documentation-style + domínio |
...
| [pose-recurrence-escalation](pose-recurrence-escalation/SKILL.md) | Escalação after `recurrence-check` flagged | [recurrence-escalation.md](../../.pose/workflows/recurrence-escalation.md) | security, documentation-style |
...
necessários to os caminhos afetados. Do not leia o catálogo inteiro por padrão.
