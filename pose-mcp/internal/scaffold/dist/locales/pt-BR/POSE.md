...
- `new-spec` — cria uma nova spec com frontmatter padrão e as 7 seções de engenharia. Por padrão gera em pastas datadas sob [`.pose/specs/`](.pose/specs/) com resolução híbrida do motor.
